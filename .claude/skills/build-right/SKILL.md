---
name: build-right
description: Build firmware for the right half of the Sofle keyboard locally
user-invocable: true
allowed-tools: Bash, Read
---

Build the right half firmware locally:
...
3. Location of `.uf2` file: `.zmk/build/right/zephyr/zmk.uf2`
